...
public class h_water_d_e_quick4cups extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public h_water_d_e_quick4cups() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("+4.29"));
        //Sleep
        solo.sleep(500);
