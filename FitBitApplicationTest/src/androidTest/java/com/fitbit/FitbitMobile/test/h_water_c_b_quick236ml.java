...
public class h_water_c_b_quick236ml extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public h_water_c_b_quick236ml() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("236.59"));
        //Sleep
        solo.sleep(500);
