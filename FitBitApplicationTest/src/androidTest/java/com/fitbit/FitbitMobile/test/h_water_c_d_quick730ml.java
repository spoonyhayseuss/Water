...
public class h_water_c_d_quick730ml extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public h_water_c_d_quick730ml() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("730.47"));
        //Sleep
        solo.sleep(500);
