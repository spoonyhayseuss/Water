...
public class h_water_d_d_quick3cups extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public h_water_d_d_quick3cups() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("+3.09"));
        //Sleep
        solo.sleep(500);
