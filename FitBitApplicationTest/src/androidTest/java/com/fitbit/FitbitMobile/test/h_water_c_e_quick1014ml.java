...
public class h_water_c_e_quick1014ml extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public h_water_c_e_quick1014ml() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("1,014.37"));
        //Sleep
        solo.sleep(500);
