...
public class h_water_d_b_quick1cup extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public h_water_d_b_quick1cup() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("+1"));
        //Sleep
        solo.sleep(500);
